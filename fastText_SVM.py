...
def generate_plots(df_analyzed, output_dir):
    ...
    plt.rcParams['font.sans-serif'] = ['Arial', 'Helvetica', 'sans-serif'] # Utiliser une police claire
    ...
    plt.suptitle("Ce graphique compare la satisfaction globale des utilisateurs pour chaque marque.", fontsize=10, y=0.92)
    ...
    plt.suptitle("Ce graphique compare la satisfaction des utilisateurs pour chaque modèle spécifique.", fontsize=10, y=0.92)
    ax.set_xlabel("Note Moyenne Donnée par les Utilisateurs (sur 5)", fontsize=12)
    ...
    plt.suptitle("Ce graphique montre si les commentaires avec 1, 2, 3, 4 ou 5 étoiles sont jugés Positifs, Négatifs ou Neutres par l'IA.", fontsize=10, y=0.92)
    ...
    plt.suptitle("Ce graphique montre si les téléphones plus chers sont mieux notés. La taille de la bulle représente son succès commercial.", fontsize=11, y=0.92)
